...
```bash
yarn add @sudophunk/hdwallet-core
yarn add @sudophunk/hdwallet-keepkey-webusb
yarn add @sudophunk/hdwallet-trezor-connect
yarn add @sudophunk/hdwallet-ledger-webusb
```
...
```javascript
import { HDWallet } from "@sudophunk/hdwallet-core";
import { isKeepKey, KeepKeyHDWallet } from "@sudophunk/hdwallet-keepkey";
import { isLedger, LedgerHDWallet } from "@sudophunk/hdwallet-ledger";
import { isTrezor, TrezorHDWallet } from "@sudophunk/hdwallet-trezor";

import { WebUSBKeepKeyAdapter } from "@sudophunk/hdwallet-keepkey-webusb";
import { WebUSBLedgerAdapter } from "@sudophunk/hdwallet-ledger-webusb";
import { TrezorAdapter } from "@sudophunk/hdwallet-trezor-connect";
```
...
```javascript
import { Keyring } from "@sudophunk/hdwallet-core";
